...
class SetterPage extends StatefulWidget {
  ...
  SetterPage({this.url, this.name, this.author, this.index, this.heroTagImage});
  @override
  State<StatefulWidget> createState() {
    return _SetterPageState();
  }
}
        ...
        children: <Widget>[
          ListTile(
            ...
            onTap: () async {
              ...
              WallpaperUtils.setWallpaper(widget.url, 1, context, _scaffoldkey);
            },
            title: const Text(
              'Only Home Screen',
              style: TextStyle(
          ...
          ListTile(
            onTap: () async {
              Navigator.of(context, rootNavigator: true).pop();
              await WallpaperUtils.sleepN(200);
              WallpaperUtils.setWallpaper(widget.url, 2, context, _scaffoldkey);
            },
            title: const Text(
              'Only Lock Screen',
              style: TextStyle(
          ...
          ListTile(
            onTap: () async {
              Navigator.of(context, rootNavigator: true).pop();
              await WallpaperUtils.sleepN(200);
              WallpaperUtils.setWallpaper(widget.url, 3, context, _scaffoldkey);
            },
            title: const Text(
              'Both',
              style: TextStyle(
                            ...
                            GestureDetector(
                              ...
                              onTap: areItemsVisible
                                  ? () async {
                                      ...
                                      await WallpaperUtils.saveImage(
                                          widget.url);
